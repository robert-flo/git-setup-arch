...
| `make clean` | Remove the local makepkg working directories, downloaded source archive, and built package artifacts. It leaves the checkout ready for a fresh build. |
